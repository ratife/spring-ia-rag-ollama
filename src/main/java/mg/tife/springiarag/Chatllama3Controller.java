...
@RestController
@RequestMapping("/api/llama3")
public class Chatllama3Controller {
    ...
    public Chatllama3Controller(ChatClient.Builder builder,VectorStore vs){
    ...
    public String sentimentOllama3(String msg) {
    ...
    public String doc(String msg) {
        ...
        List<Document> documents = vectoreStore.similaritySearch(
        		SearchRequest.query(msg).withTopK(10));
